<#
    .SYNOPSIS #    One time set up of credentials file for Twitter
...
$Credential = New-Object –TypeName System.Management.Automation.PSCredential –ArgumentList "TwitterSecret", $PWord
