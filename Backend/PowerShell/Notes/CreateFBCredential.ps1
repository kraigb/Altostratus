<#
    .SYNOPSIS #    One time set up of credentials file for FB
...
$Credential = New-Object –TypeName System.Management.Automation.PSCredential –ArgumentList "FB_AppSecret", $PWord
